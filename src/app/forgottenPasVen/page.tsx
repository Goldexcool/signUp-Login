                    ...
                    <div className='flex items-center flex-col mt-[3rem] w-full'>
                        ...
                        <div className='mt-[3rem]  max-w-[100%] sm:w-[450px] w-full flex flex-col md:gap-[3rem] gap-[1rem]' >
                            ...
                            <div className='flex justify-center items-center w-full' >
                                <div className=' flex justify-center items-center  md:px-[5rem] px-[2rem]  py-2 gap-2 bg-color1 pointer text-white  rounded-3xl cursor-pointer' onClick={() => router.push('/emailVerVen')}>
                                    <p className=''>Next</p>
