          ...
          <div className='flex items-center flex-col'>
            ...
            <div className='mt-[1rem] p-6 rounded-lg shadow-lg shadow-cyan-500/50 max-w-[100%]  sm:w-[450px] bg-white w-full' >
              <div className='flex flex-col gap-7'>
                ...
                <p className='text-[0.6rem] text-color1 font-bold font-fold flex justify-end cursor-pointer mt-[-13px]' onClick={() => router.push('/forgotPas')} >Forgot Password?</p>
                ...
                <div className='flex justify-center items-center mt-[-18px] mb-[2rem] opacity '>
                  <p className='text-[10px]'>Need an account? <button className='font-bold' onClick={() => router.push('/signup')}>Create an account</button></p>
                </div>
              </div>
            </div>
          </div>
